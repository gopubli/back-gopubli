...
return new class extends Migration
{
    ...
    {
        // Tokens de reset para administradores
        ...
        // Tokens de reset para influencers
        Schema::create('influencer_password_resets', function (Blueprint $table) {
            $table->string('email')->index();
            $table->string('token');
            $table->timestamp('created_at')->nullable();
        });
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('influencer_password_resets');
    }
};
